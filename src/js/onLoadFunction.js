...
export async function onLoad() {
    ...
    return axios.get(`${URL}?key=${KEY}&q=${searchName}&image_type=photo&orientation=horizontal&safesearch=true&per_page=40&page=${page}`)
    .then( response => {

        refs.gallery.insertAdjacentHTML('beforeend', renderMarkup(response, page));
